...
def train(learning_rate, batch_size, num_epochs, save_every, tensorboard_vis, print_summary):
    ...
    def get_gen(x): return datagen.flow_from_directory(
        '/itet-stor/himeva/net_scratch/x8_data/{}'.format(x),
        target_size=(320, 320),
    ...
    if os.path.exists('models/aresnet50.h5'):
        # load model
    ...
    resnet50.fit_generator(
        train_generator,
        steps_per_epoch=648//batch_size,
        epochs=num_epochs,
        verbose=1,
    ...
    # save model
    logging.info('Saving trained model to `models/x8_resnet50.h5`')
    resnet50.save('models/x8_resnet50.h5')
    ...
    keras.utils.plot_model(resnet50, to_file='models/x8_resnet50.png')
