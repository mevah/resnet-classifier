...
def train(learning_rate, batch_size, num_epochs, save_every, tensorboard_vis, print_summary):
    ...
    def get_gen(x): return datagen.flow_from_directory(
        '/itet-stor/himeva/net_scratch/x4_data/{}'.format(x),
        target_size=(320, 320),
    ...
    # save model
    logging.info('Saving trained model to `models/x4_resnet50.h5`')
    resnet50.save('models/x4_resnet50.h5')
    ...
    keras.utils.plot_model(resnet50, to_file='models/x4_resnet50.png')
